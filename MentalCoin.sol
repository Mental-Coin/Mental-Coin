...
/**
  Every transaction consumes your $MENTAL:
    2% fee is auto added to the liquidity pool on PancakeSwap
    2% fee is auto distributed to all $MENTAL holders
    2% fee is sent to a charity wallet (denominated in BNB)
...
contract MENTALCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 250000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Mental Coin";
    string private _symbol = "MENTAL";
    ...
    uint256 public _maxTxAmount = 1500000 * 10**1 * 10**9;
